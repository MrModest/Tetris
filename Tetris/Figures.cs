...
namespace Tetris
{
    ...
    public abstract class Figure
    {
        ...
        public int hPos { get; set; } //horiontal position in Grid
        public int vPos { get; set; } //vertical position in Grid
        public Angle angle { get; set; } = Angle.Deg0;
        public int width { get; set; } //count blocks in horizontal
        public int height { get; set; } //count blocks in vertical
    ...
    public class Line : Figure                                                     //0
    {                                                                              //0
        public Line(int hPos, int vPos, Color color) : base(hPos, vPos, color)     //0
        {                                                                          //0
            width = 1;
            height = 4;
        }
    ...
    public class LThunder : Figure                                                     //0_
    {                                                                                  //00
        public LThunder(int hPos, int vPos, Color color) : base(hPos, vPos, color)     //_0
        {
            width = 2;
            height = 3;
        }
    ...
    public class RThunder : Figure                                                           //_0
    {                                                                                        //00
        public RThunder(int hPos, int vPos, Color color) : base(hPos, vPos, color)           //0_
        {
            width = 2;
            height = 3;
        }
    ...
    public class LeftT : Figure                                                           //00
    {                                                                                     //_0
        public LeftT(int hPos, int vPos, Color color) : base(hPos, vPos, color)           //_0
        {
            width = 2;
            height = 3;
        }
    ...
    public class RightT : Figure                                                             //00
    {                                                                                        //0_
        public RightT(int hPos, int vPos, Color color) : base(hPos, vPos, color)             //0_
        {
            width = 2;
            height = 3;
        }
    ...
    public class Triangle : Figure                                                       //000
    {                                                                                    //_0_
